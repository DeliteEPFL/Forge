...
trait Definitions extends DerivativeTypes {
  ...
  lazy val PUnit = tpe("Unit", stage = compile)
  lazy val MNothing = tpe("Nothing")
  lazy val CNothing = tpe("Nothing", stage = now)
  lazy val PNothing = tpe("Nothing", stage = compile)
